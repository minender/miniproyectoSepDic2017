                ...
                match(C_BRACKET2);
                                                                  ...
                                                                  if (((ExprContext)_localctx).vl.value.size() != ((ExprContext)_localctx).el.value.size()) {
                                                                    try {
                                                                        ...
                                                                        e.printStackTrace();
                                                                        System.out.println("Cai en el error 0"); return null;
                                                                    }
                                                                  }
                                              else
            ...
            case S:
                ...
                match(C_BRACKET);
                                            ...
                                            try {
                                                ...
                                                e.printStackTrace();
                                                System.out.println("Cai en el error 2"); return null;
                                            }
            ...
            case Si:
                ...
                match(Si);
                            ...
                            try {
                                ...
                                e.printStackTrace();
                                System.out.println("Cai en el error 3"); return null;
                            } 
                 ...
                 /*String templ="(L^{\\lambda x_{122}. c_{1} (%(arg2)) x_{122}} A^{%(arg1)}) (I^{[x_{112}:=%(arg2)]} A^{= (\\Phi_{K} T) (\\Phi_{(b,)} c_{1})})";
                                            ...
                                            try {
                                               ((Prove_baseContext)_localctx).value =  new TypedM(((Prove_baseContext)_localctx).expr.value, u);
                                                ...
                                                e.printStackTrace();
                                                System.out.println("Cai en el error 4"); return null;
                                            }
