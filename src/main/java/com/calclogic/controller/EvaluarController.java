...
public class EvaluarController {
    ...
    public String pruebaPredicadoView(@PathVariable String username, ModelMap map) {
        ...
        //Term t = CombUtilities.getTerm("\\Phi_{(cc(((c((c(c((cb,),),),),),),),),)}", "AdminTeoremas", TypedA.sm_);
        //Term t = CombUtilities.getTerm("\\Phi_{(c(c((cb,),),),)}", "AdminTeoremas", TypedA.sm_);
        //Term t = CombUtilities.getTerm("\\Phi_{((c(c((cb,),),),),)}", "AdminTeoremas", TypedA.sm_);
        //Term t = CombUtilities.getTerm("\\Phi_{(bbc(cbc,),cbbb(c,bc(cbc,)))}", "AdminTeoremas", TypedA.sm_);
        //Term t = CombUtilities.getTerm("\\Phi_{(,c)}", "AdminTeoremas", TypedA.sm_);
        Term t;// = CombUtilities.getTerm("\\Phi_{((b,),)}", "AdminTeoremas", TypedA.sm_);
        t = CombUtilities.getTerm("(\\Phi_{b} (\\Phi_{bb} \\Phi_{b}))", "AdminTeoremas", TypedA.sm_);
