...
public class EvaluarController {
    ...
    public String pruebaPredicadoView(@PathVariable String username, ModelMap map) {
        ...
        //Term t = CombUtilities.getTerm("I^{[x_{113},x_{112} := (c_{7} (c_{5} x_{113} (c_{4} x_{113} x_{112}))),(c_{7} (c_{5} x_{113} x_{112}))]} A^{= (\\Phi_{cbbb} c_{7} \\Phi_{bb} c_{2} c_{7}) (\\Phi_{bb} \\Phi_{b} c_{3})} (I^{[x_{113},x_{112} := (c_{5} x_{113} (c_{4} x_{113} x_{112})),(c_{5} x_{113} x_{112})]} A^{= (\\Phi_{cbbb} c_{7} \\Phi_{bb} c_{3} c_{7}) (\\Phi_{bb} \\Phi_{b} c_{2})} (I^{[x_{114},x_{113},x_{112} := x_{113},(c_{4} x_{113} x_{112}),x_{112}]} A^{= (\\Phi_{K} (\\Phi_{K} (\\Phi_{K} T))) (\\Phi_{c(ccbb,b)} c_{2} c_{2} (\\Phi_{(bbb,b)} c_{2}) \\Phi_{(cbbb,b)} c_{5} c_{5})} A^{= (\\Phi_{K} (\\Phi_{K} T)) (\\Phi_{bb} (\\Phi_{(bb,)} c_{2}) c_{4})}))", "AdminTeoremas", TypedA.sm_);
