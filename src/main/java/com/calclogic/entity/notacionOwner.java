...
public abstract class notacionOwner {
  ...
  /**
   * This method returns a list with the variables names of this symbol's notation, for example for
   * %(a1) %(op) %(a2) would return ["a1", "a2"]
   *
   ...
   * @param extraBackSlash boolean that represents if you want to add another backslash to every
   *     backslash in the answer, this usually should be false but sometimes in jsp views your first
   *     backslash will get consumed so you'll need another
