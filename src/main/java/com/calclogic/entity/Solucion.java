...
public class Solucion implements Serializable {
  ...
  @SequenceGenerator(
      name = "solucion_id_seq",
      sequenceName = "solucion_id_seq",
      allocationSize = 1)
  private int id;
  ...
  @JoinColumn(name = "resuelveid", nullable = false)
  ...
  public void eraseCaseAnalysis() {
    String[] arr = metodo.split(":");
    if (arr.length == 2) this.metodo = arr[0];
  }
  ...
  public void setMetodo(String metodo) {
    ...
    if (metodo != null) {
      arr = metodo.split(":");
      if (arr.length == 2) this.metodo = metodo + ":" + arr[1];
  ...
  private Term branchedOneLineSubProof(Term formula, Term father, String user) {
    ...
    // String metaTheoT= "S (I^{[x_{113} := %(ST1)]} A^{c_{1} x_{113} (c_{1} x_{113} c_{8})})
    // (L^{\\lambda x_{122}.%(ST2)} A^{c_{1} x_{113} x_{113}})";
    String metaTheoT =
        "I^{[x_{113}:= %(ST2)]} A^{= (\\Phi_{(b,)} c_{1}) (\\Phi_{K} c_{8})} (L^{\\lambda x_{122}. c_{1} x_{122} (%(ST2))} (L^{\\lambda x_{122}.%(ST2)} A^{= (\\Phi_{(b,)} c_{1}) (\\Phi_{K} c_{8})}))";
    String metaTheo = sub1.replace(metaTheoT);

    try {
      Term newProof =
          new TypedApp(
              ((App) ((App) ((App) father).p).q).p,
              CombUtilities.getTerm(metaTheo, user, TypedA.sm_));
  ...
  private Term mergeSubProofs(Term subProof, List<Term> fathers, String user) {
    if (fathers.size() == 1) return subProof;
    else {
      Term auxProof;
      int i;
      if (subProof == null || !(subProof instanceof TypedTerm)) { // subProof.type()==null) {
        ...
        auxProof =
            (subProof == null
                ? ((TypedApp) fathers.get(1)).q
                : branchedOneLineSubProof(subProof, fathers.get(1), user));
      } else {
        i = 1;
        auxProof = subProof;
      }
  ...
  public void deleteFinishStack(Term methodTerm, Term statement, Term caseAn) {
    ...
    if (T != null
        && T[0] instanceof TypedTerm /*T[0].type()!=null*/
  ...
  public int retrocederPaso(
      String user, Term methodTerm, GenericProofMethod objectMethod, SimboloManager s) {
    ...
    if ((!currentGroupMethod.equals("T")
            && auxTypedTerm instanceof App
            && ((App) auxTypedTerm).p.containTypedA())
        ||
        ...
        (currentGroupMethod.equals("T")
            && ((auxTypedTerm instanceof TypedApp && ((TypedApp) auxTypedTerm).inferType == 't')
                || (auxTypedTerm instanceof TypedApp
                    && ((TypedApp) auxTypedTerm).inferType == 'e'
                    && ((TypedApp) auxTypedTerm).p instanceof TypedApp
                    && ((TypedApp) ((TypedApp) auxTypedTerm).p).inferType == 'l')
                || (auxTypedTerm instanceof TypedApp
                    && ((TypedApp) auxTypedTerm).inferType == 'm'
                    && ((TypedApp) auxTypedTerm).p instanceof TypedApp
                    && ((TypedApp) ((TypedApp) auxTypedTerm).p).inferType == 'm'
                    && ((TypedApp) ((TypedApp) auxTypedTerm).p).p instanceof TypedApp
                    && ((TypedApp) ((TypedApp) ((TypedApp) auxTypedTerm).p).p).inferType
                        == 'i')))) {
      if (currentGroupMethod.equals("T")
          && !(auxTypedTerm instanceof TypedApp
              && (((TypedApp) auxTypedTerm).inferType == 't'
                  || ((TypedApp) auxTypedTerm).inferType == 'e'))) {
        String axiom =
            "= (\\Phi_{K} (\\Phi_{K} (\\Phi_{K} T))) (\\Phi_{(ccb,)} c_{2} (\\Phi_{(bbb,cb)} c_{2}) (\\Phi_{c(cbbb,)} c_{1}))";
        if (((TypedA) ((TypedApp) ((TypedApp) ((TypedApp) auxTypedTerm).p).p).q)
            .getCombDBType()
            .equals(axiom))
          typedTerm =
              mergeSubProofs(
                  ((TypedM) ((TypedApp) ((TypedApp) auxTypedTerm).p).q).getSubProof(), li, user);
        else typedTerm = mergeSubProofs(((App) ((App) auxTypedTerm).p).q, li, user);
        // me parece que este if no va, ya que es imposible aqui que inferType=='e'
        if (auxTypedTerm instanceof TypedApp
            && ((TypedApp) auxTypedTerm).inferType == 'e'
            && ((TypedApp) auxTypedTerm).p instanceof TypedApp
        ...
        else typedTerm = mergeSubProofs(((App) auxTypedTerm).p, li, user);
