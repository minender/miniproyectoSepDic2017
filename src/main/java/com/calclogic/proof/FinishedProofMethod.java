 ...
 * @author ronald
 */
public class FinishedProofMethod {
    @Autowired
    private static SimboloManager simboloManager;
    @Autowired
    private static ResuelveManager resuelveManager;

    /**
     * This function checks if a base demonstration has finished depending on the method used.If it determines it has not finished, it returns the same proof tree given as argument.
     * 
     ...
     */
    public static Term finishedBaseMethodProof(Term theoremBeingProved, Term proof, String username, String method) {
     ...
     */
    public static Term finishedWaitingMethodProof(Term theoremBeingProved, Term proof, String method) {
        try {
