                                    ...
                                    <c:when test="${(!resu.isResuelto()) && resu.getDemopendiente() < 1}">
                                        <li>
                                            <p>
                                                ...
                                                (${resu.getNumeroteorema()}) ${resu.getNombreteorema()}: &nbsp; ${resu.getTeorema().getTeoTerm().toStringLaTeXJavascript(simboloManager,predicadoManager,"",resu.getNumeroteorema())}
                                                <c:choose>
                                            ...
                                            <p>
                                                <c:choose>
                                                    <c:when test="${!resu.isEsAxioma()}">
                                                        ...
                                                        <a href="javascript:buscarSoluciones(${resu.getTeorema().getId()});" title="Haga click para ver las demostraciones del teorema">(${resu.getNumeroteorema()}) ${resu.getNombreteorema()}: </a> &nbsp; ${resu.getTeorema().getTeoTerm().toStringLaTeXJavascript(simboloManager,predicadoManager,"",resu.getNumeroteorema())}
