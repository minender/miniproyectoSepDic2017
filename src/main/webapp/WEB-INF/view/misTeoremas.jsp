                      ...
                      <li >
                        <p >
                            ...
                            <c:when test="${!resu.isEsAxioma()}">
                                ...
                                <a href="javascript:buscarMetaSoluciones(${resu.getTeorema().getId()});" title="Haga click para ver las demostraciones del teorema">Duality principle for (${resu.getNumeroteorema()}): </a> &nbsp; ${resu.getTeorema().getMetateoTerm().toStringInfJavascript(simboloManager,predicadoManager,"",resu.getNumeroteorema())}
                                </span>
                            </c:when>
                            <c:otherwise>
                                <i class="fa fa-unlock" aria-hidden="true" ></i>
                                ...
                                if (!teoremas[j].isResuelto && teoremas[j].demopendiente < 1){
                                    ...
                                    if (!teoremas[j].isAxioma){
                                        if (teoremas[j].isResuelto){
                                            newRows = newRows + "<a class='expandmeta' onclick='expandMeta(" + teoremas[j].teoremaid + ")'><i class='fa fa-plus-circle' aria-hidden='true'></i></a><i class='fa fa-unlock' aria-hidden='true'></i><a href='javascript:buscarSoluciones(" + teoremas[j].teoremaid + ");' title='Haga click para ver las demostraciones del teorema'>(" + teoremas[j].numeroteorema + ")" +  teoremas[j].nombreteorema + ": </a> &nbsp; $" + teoremas[j].string + "$<span class='d-none' id='" + teoremas[j].teoremaid + "'><br><span class='metaitem'></span><a href='javascript:buscarMetaSoluciones(" + teoremas[j].teoremaid + ");' title='Haga click para ver las demostraciones del teorema'>Duality principle for (" + teoremas[j].numeroteorema + "): </a> &nbsp; $" + teoremas[j].metateoremastring + "$</span>"
                                        }
                                        else{
